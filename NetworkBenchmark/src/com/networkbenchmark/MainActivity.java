...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Parse.initialize(this, "qT4wyDLVqILutqN3RRTbUxLwqiXFIHPXqnsVX7B5",
				"FGWV2oti13RNZrVendUhCW2TsmV8TbkOB3AjbWfO");
	...
	public void savePerfMeasure(View view) {
		...
		alertbox("Save Results",
				"The performance results are saved successfully.");
	}
